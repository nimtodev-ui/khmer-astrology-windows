...
| `អដ្ឋភុជ្ជ` | `B37:B40` | Khmer-year epoch and Julian-day expressions | Sankranta reference values | `KhmerCalendarCalculator` | `CalculateSankranta` |
| `អដ្ឋភុជ្ជ` | `B41:B46` | `INT(...)+1`, rounded seconds, and `MOD(INT(...+0.5)+1,7)+1` | Maha Sankranta day/time and weekdays | `KhmerCalendarCalculator` | `Calculate` |
